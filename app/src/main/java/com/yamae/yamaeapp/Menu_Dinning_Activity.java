 ...
 */
public class Menu_Dinning_Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_dinning);
        ...
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(0xffe7ec2a));   //액션바색
        ...
        Thread thread=new Thread(new Runnable() {
            ...
            public void run() {
                ...
                query.whereContains("Category","1");
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent detail1=new Intent(Menu_Dinning_Activity.this, DetailActivity.class);
